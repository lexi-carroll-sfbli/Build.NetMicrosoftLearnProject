...
Console.Write("Hello, {0}!", SetFirstName.firstName);
Console.Write($" You have {SetNumberOfEmails.numberOfEmails} emails in your inbox. ");
Console.WriteLine($"The temperature is {SetTemperatureInCelcius.temperatureInCelcius} Celsius.");
Console.WriteLine("");
